...
public enum ErrorCode {
    ...
    INVALID_ORDER_STATUS(HttpStatus.BAD_REQUEST, "유효하지 않은 주문 상태입니다."),  // 400
    ...
    // 장바구니 관련
    CART_EMPTY(HttpStatus.BAD_REQUEST, "장바구니가 비어 있습니다."),                 // 400

    // 쿠폰/포인트 관련
    COUPON_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 쿠폰입니다."),            // 404
    INVALID_COUPON(HttpStatus.BAD_REQUEST, "사용할 수 없는 쿠폰입니다."),           // 400
    INVALID_POINTS(HttpStatus.BAD_REQUEST, "사용할 수 없는 포인트입니다."),         // 400
